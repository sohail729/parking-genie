                                ...
                                <table class="datatable-init-export nowrap table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="rowID-{{ $customer->id }}">
                                            ...
                                            <td>{{$customer->municipality ?? 'N/A'}}</td>
                                           <td> {{ getFormattedDate($customer->created_at, 'dS M Y') }} </td>
                                            <td>
                                            ...
                                            <td>
                                                {{-- <div class="btn-group" role="group" aria-label="Basic example">
                                                    <a id="delete" class="btn btn-danger btn-sm"
                                                        href='javascript:void(0)' data-id='{{ $customer->id }}'
                                                        data-route='{{ route("admin.users.destroy", $customer->id) }}'><em
                                                            class="icon ni ni-trash"></em></a>
                                                </div> --}}
                                                <div class="btn-group" role="group" aria-label="Basic example">
                                                    <a id="edit" class="btn btn-info btn-sm"
                                                        href='{{ route("admin.users.edit", $customer->id) }}'><em
